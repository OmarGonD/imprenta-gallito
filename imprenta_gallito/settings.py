...
ACCOUNT_CONFIRM_EMAIL_ON_GET = True  # Valida al dar clic en el enlace inmediatamente
...
EMAIL_USE_TLS = config("EMAIL_USE_TLS", default=False, cast=bool)  # False para puerto 465
EMAIL_USE_SSL = config("EMAIL_USE_SSL", default=True, cast=bool)   # True para puerto 465
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="hola@imprentagallito.com")
